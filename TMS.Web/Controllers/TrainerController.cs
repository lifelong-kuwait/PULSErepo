...
namespace TMS.Web.Controllers
{
    public class TrainerController : TMSControllerBase
    {
        ...
        public ActionResult Trainer_Read([DataSourceRequest] DataSourceRequest request,long RoleID)
        {
            ...
            {
                var _trainer = this._TrainerBAL.TrainerOrganization_GetAllBAL(ref Total,CurrentCulture, RoleID, Convert.ToString(CurrentUser.CompanyID), SearchText, request.Sorts.ToString(), startRowIndex, request.Page, request.PageSize,0,false);
