...
<asp:UpdatePanel runat="server" ID="UpTraineeReport" UpdateMode="Conditional">
    <ContentTemplate>
        ...
        <fieldset>
            ...
            <div class="col-md-5">
                    <asp:TextBox ID="TxtEndDate" runat="server" autocomplete="off" type="date"  class="form-control"
           ...
           <div  class="col-md-6 pull-right"  style="margin-top:10px;">
                <asp:Button ID="BtnView" runat="server" CausesValidation="True" OnClick="BtnView_OnClick"
                    Text="View" ValidationGroup="VgAttendanceReport" CssClass="ButtonFiled" Visible="True" />
            </div>
         </div>
               <fieldset class="RDLCReport">
                <rsweb:ReportViewer ID="ReportViewerMasterReport" runat="server" Width="100%" Height="100%"
                    ...
                    WaitMessageFont-Size="14pt" CssClass="MaxTable" ShowRefreshButton="False" ShowZoomControl="False">
                    <LocalReport ReportPath="Report\WeeklyUtilizationReport.rdlc">
                    </LocalReport>
                </rsweb:ReportViewer>
