...
namespace TMS.DataObjects.TMS.Trainers
{
    public interface ITrainerDAL
    {
        ...
        /// <returns>IList&lt;Trainer&gt;.</returns>
        IList<Trainer> TrainerOrganization_GetAllDAL(ref int Total,string  culture, long RoleID, string ID,  string SearchText, string SortExpression, int StartRowIndex, int page, int PageSize,long personID);
