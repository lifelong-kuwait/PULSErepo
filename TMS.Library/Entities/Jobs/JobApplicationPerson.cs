...
{
    public class JobApplicationPerson :IDataMapper
    {/// <summary>
     ...
     /// <value>The identifier.</value>
        ...
        //,[OrganizationID]
        public long JobOrganizationID { get; set; }
        // ,[CreatedBy]
        public long JobCreatedBy { get; set; }
        // ,[CreatedOn]
        public DateTime CreatedOn { get; set; }
        // ,[UpdatedBy]
        public long JobUpdatedBy { get; set; }
        // ,[UpdatedOn]
        ...
        public void MapProperties(DbDataReader dr)
        {
            ...
            JobOrganizationID = dr.GetLong("JobOrganizationID");
           // OrganizationID = dr.GetLong("OrganizationID");
            JobIsActive = dr.GetBoolean("JobIsActive");
            JobIsDeleted = dr.GetBoolean("JobIsDelete");
            JobCreatedBy = dr.GetLong("JobCreatedBy");
            CreatedOn = dr.GetDateTime("CreatedOn");
            JobUpdatedBy = dr.GetLong("JobUpdateBy");
